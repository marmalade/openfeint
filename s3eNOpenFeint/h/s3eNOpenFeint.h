 ...
 */
#ifndef S3E_EXT_NOPENFEINT_H
#define S3E_EXT_NOPENFEINT_H
...
/**
 * Returns S3E_TRUE if the NOpenFeint extension is available.
 */
 ...
 *
 * The available callback types are listed in @ref s3eNOpenFeintCallback.
 ...
 *         Call s3eNOpenFeintGetError() to retrieve an error code.
 *         This will return one of:
 *   - @ref S3E_FILE_ERR_PARAM if @e cbid is not a valid member of @ref s3eNOpenFeintCallback.
 *   - @ref S3E_FILE_ERR_NOT_FOUND if @e fn is not registered for callback @e cbid.
 * @note For more information on the systemData passed as a parameter to the callback
 * registered using this function, see the s3eNOpenFeintCallback enum.
 * @note It is not necessary to define a return value for any registered callback.
 * @see s3eNOpenFeintRegister
 */
 ...
 * @see s3eNOpenFeintGetError
 *
 * @remark This function, as opposed to s3eNOpenFeintGetError(), will always
 ...
 * @see s3eNOpenFeintGetErrorString
 *
