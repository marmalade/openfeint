...
///
/// Behavior: 	If this setting is present and set to YES,
///				the web ui will refrain from using memory mapping to speed up some operations
///
////////////////////////////////////////////////////////////
extern NSString* OpenFeintSettingThriftyWebUIMemoryUsage;

typedef enum 
{
    OFDevelopmentMode_RELEASE,
    OFDevelopmentMode_DEVELOPMENT,
    OFDevelopmentMode_VERBOSE_DEVELOPMENT,
} OFDevelopmentMode;

////////////////////////////////////////////////////////////
///
/// @type		NSNumber EDevelopmentMode
/// @default	There is no default.  This must be set.
/// @behavior	
///				OFDevelopmentMode_RELEASE:              Minimal console output, and no developer-facing alerts
///				OFDevelopmentMode_DEVELOPMENT:          More console output, and developer facing alerts
///				OFDevelopmentMode_VERBOSE_DEVELOPMENT:	Same as OFDevelopmentMode_DEVELOPMENT,
///                                                         but with more verbose console output
///
///             It is recommended that you do something such as the following when defining this setting:
///
///             #ifdef DEBUG
...
///
////////////////////////////////////////////////////////////
extern NSString* OpenFeintSettingDevelopmentMode;
