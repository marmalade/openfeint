...
{
	UIActivityIndicatorView* loadingIcon = (UIActivityIndicatorView*)[self findViewByTag:1];
	if(value)
	{
	...
	UILabel* loadingText = (UILabel*)[self findViewByTag:2];
	UILabel* showingText = (UILabel*)[self findViewByTag:3];
