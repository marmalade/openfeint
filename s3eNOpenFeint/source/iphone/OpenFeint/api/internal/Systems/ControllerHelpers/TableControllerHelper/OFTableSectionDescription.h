...
typedef enum OFTableSectionCellTypes {
    OFTableSectionCellTypeLeading,
    OFTableSectionCellTypeStatic,
    OFTableSectionCellTypeResource,
    OFTableSectionCellTypeAction,
    OFTableSectionCellTypeTrailing,
    OFTableSectionCellTypeError
} OFTableSectionCellTypes;


typedef struct {
    NSUInteger dataRow;
    NSUInteger cellType;
} OFTableSectionRowData;
...
//the actual resource can be found with [self.page objectAtIndex:retBlock.dataRow]
