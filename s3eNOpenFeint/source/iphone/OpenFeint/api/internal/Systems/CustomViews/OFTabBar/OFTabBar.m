...
- (UIViewController*)_loadTabItemViewController:(NSString*)viewControllerName forTab:(OFTabBarItem*)tabBarItem
{
	...
	{
		return [[OFControllerLoaderObjC loader] load:viewControllerName];// load(viewControllerName);
	}
}
