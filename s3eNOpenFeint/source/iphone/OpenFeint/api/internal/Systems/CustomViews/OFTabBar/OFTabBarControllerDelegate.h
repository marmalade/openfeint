...
- (void)tabBarController:(OFTabBarController*)tabBarController willUnloadViewController:(UIViewController*)viewController fromTab:(OFTabBarItem*)tabItem;
