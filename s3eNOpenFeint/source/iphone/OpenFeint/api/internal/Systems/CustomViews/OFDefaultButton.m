...
+ (NSString*)buttonImageName:(NSString*)name
{
    NSString *suffix = [OpenFeint isLargeScreen] ? @"IPad" : @"";
    return [NSString stringWithFormat:@"OFButton%@%@.png", name, suffix];
}
...
{
	return [[[OFDefaultButton alloc] initWithFrame:_frame normalImage:[self buttonImageName:@"Green"] hitImage:@"OFButtonGreenHit.png"] autorelease];
}
...
+ (void)setupButton:(OFDefaultButton*)button
{
	[button _setupBackgroundImage:[self buttonImageName:@"Red"] hitImage:[self buttonImageName:@"RedHit"]];
	[button _setupStandardButtonAttributes];
}
...
+ (void)setupButton:(OFDefaultButton*)button
{
	[button _setupBackgroundImage:[self buttonImageName:@"Green"] hitImage:[self buttonImageName:@"GreenHit"]];
	[button _setupStandardButtonAttributes];
}
...
@implementation OFGreyButton

+ (void)setupButton:(OFDefaultButton*)button
{
	[button _setupBackgroundImage:@"OFButtonSmallGrey.png" hitImage:@"OFButtonSmallGreyHit.png"];
	[button _setupStandardButtonAttributes];
}
...
#pragma mark Grey Shadowed Button

@implementation OFShadowedGreyButton

+ (void)setupButton:(OFDefaultButton *)button
{
    UIImage* bgImage = [[OFImageLoader loadImage:@"OFButtonShadowGrey.png"] stretchableImageWithLeftCapWidth:20 topCapHeight:20];
    [button setBackgroundImage:bgImage forState:UIControlStateNormal];
}

@end

#pragma mark Green Shadowed Button

@implementation OFShadowedGreenButton

+ (void)setupButton:(OFDefaultButton *)button
{
    UIImage* bgImage = [[OFImageLoader loadImage:@"OFButtonShadowGreen.png"] stretchableImageWithLeftCapWidth:20 topCapHeight:20];
    [button setBackgroundImage:bgImage forState:UIControlStateNormal];
}
