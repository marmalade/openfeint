...
// This is a helper class used by OFASIHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface OFASIDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
