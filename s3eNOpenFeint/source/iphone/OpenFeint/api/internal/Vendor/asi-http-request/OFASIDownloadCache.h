...
#import "OFASICacheDelegate.h"

@interface OFASIDownloadCache : NSObject <OFASICacheDelegate> {
	...
	// Defaults to a directory called 'OFASIHTTPRequestCache' in the temporary directory
...
// Returns a static instance of an OFASIDownloadCache
// In most circumstances, it will make sense to use this as a global cache, rather than creating your own cache
// To make OFASIHTTPRequests use it automatically, use [OFASIHTTPRequest setDefaultCache:[OFASIDownloadCache sharedCache]];
+ (id)sharedCache;
...
// Do not use this formatter for parsing dates because the format can vary slightly - use OFASIHTTPRequest's dateFromRFC1123String: class method instead
