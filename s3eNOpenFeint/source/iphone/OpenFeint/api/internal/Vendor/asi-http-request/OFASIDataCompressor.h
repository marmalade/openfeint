...
// This is a helper class used by OFASIHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface OFASIDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
