...
typedef enum _ASICachePolicy {
	...
	// OFASIDownloadCache's default cache policy is 'ASIAskServerIfModifiedWhenStaleCachePolicy'
...
// Calling [OFASIHTTPRequest clearSession] will remove any data stored using ASICacheForSessionDurationCacheStoragePolicy
...
@protocol OFASICacheDelegate <NSObject>
