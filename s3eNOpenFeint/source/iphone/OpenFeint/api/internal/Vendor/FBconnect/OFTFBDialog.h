...
@interface UIImage(OpenFeintFBConnect)
...
@interface OFTFBDialog : UIView <UIWebViewDelegate> {
 ...
 * The delegate.
 */
@property(nonatomic,assign) id<OFFBDialogDelegate> delegate;

/**
 * The session for which the login is taking place.
 */
@property(nonatomic,assign) OFFBSession* session;
