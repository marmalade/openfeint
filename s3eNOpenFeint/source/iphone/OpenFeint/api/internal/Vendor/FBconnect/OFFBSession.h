 ...
 */
@interface OFFBSession : NSObject {
 ...
 */
- (void)sessionDidNotLogin:(OFFBSession*)session;

/**
 * Called when a session is about to log out.
 */
- (void)session:(OFFBSession*)session willLogout:(FBUID)uid;
