...
- (MPOAuthAPIRequestLoader*)createLoaderForRequestToken
{
	...
	return [self createLoaderForMethod:nil 
					...
					withParameters:nil 
					withHttpMethod:@"GET"
                 withSuccessInvocation:[OFInvocation invocationForTarget:self selector:@selector(_authenticationRequestForRequestTokenSuccessfulLoad:)]
                 withFailureInvocation:nil];
...
- (void)performMethod:(NSString *)inMethod withSuccessInvocation:(OFInvocation*)onSuccess withFailureInvocation:(OFInvocation*)onFailure
{
	[self performMethod:inMethod atURL:self.baseURL withParameters:nil withSuccessInvocation:onSuccess withFailureInvocation:onFailure];
}

- (void)performMethod:(NSString *)inMethod atURL:(NSURL *)inURL withParameters:(NSArray *)inParameters withSuccessInvocation:(OFInvocation*)onSuccess withFailureInvocation:(OFInvocation*)onFailure 
{
	[self performMethod:inMethod atURL:inURL withParameters:inParameters withHttpMethod:@"GET" withSuccessInvocation:onSuccess withFailureInvocation:onFailure];
}
                            ...
                            withFailureInvocation:(OFInvocation*)onFailure
{
	...
	[loader setSuccessInvocation:onSuccess];
	[loader setFailureInvocation:onFailure];
...
withFailureInvocation:(OFInvocation*)onFailure
{
	MPOAuthAPIRequestLoader* loader = [self createLoaderForMethod:inMethod atURL:inURL withParameters:inParameters withHttpMethod:httpMethod 
                                                      withSuccessInvocation:onSuccess withFailureInvocation:onFailure];
