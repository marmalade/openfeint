...
+ (NSString *)HMAC_SHA1SignatureForText:(NSString *)inText usingSecret:(NSString *)inSecret {
	...
	of_hmac_sha1((unsigned char *)[textData bytes], [textData length], (unsigned char *)[secretData bytes], [secretData length], result);
	
	//Base64 Encoding
	char base64Result[32];
	size_t theResultLength = 32;
	OFBase64EncodeData(result, 20, base64Result, &theResultLength);
