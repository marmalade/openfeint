...
typedef enum OFUserDistanceUnitType { kDistanceUnitNotDefined = 0, kDistanceUnitNotAllowed, kDistanceUnitMiles, kDistanceUnitKilometers } OFUserDistanceUnitType;
