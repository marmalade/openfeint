...
@package
	...
	NSUInteger imsUnreadCount;
	NSUInteger subscribedThreadsUnreadCount;
	NSUInteger invitesUnreadCount;
	
	NSUInteger unfulfilledInvitesCount;
...
@property (nonatomic, readonly) NSUInteger imsUnreadCount;
@property (nonatomic, readonly) NSUInteger subscribedThreadsUnreadCount;
@property (nonatomic, readonly) NSUInteger invitesUnreadCount;
@property (nonatomic, readonly) NSUInteger unfulfilledInvitesCount;

@property (nonatomic, readonly) NSString* suggestionsForumId;
@property (nonatomic, readonly) NSString* initialDashboardScreen;
@property (nonatomic, readonly) NSString* initialDashboardModalContentURL;
