...
//This needs to be a static member
@property (nonatomic, readonly) OFPaginatedSeries* announcements;
@property (nonatomic, assign) uint unseenAnnouncementCount;
