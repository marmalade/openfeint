...
@interface OFGameCenterHighScore : NSObject {
    NSArray* scores;
    BOOL silently;
    NSString* message;
    OFInvocation* mSuccessInvocation;
    OFInvocation* mFailureInvocation;
    OFInvocation* mUploadBlobInvocation;
...
-(id)initWithSeries:(NSArray*) scores;
-(OFRequestHandle*)submitOnSuccessInvocation:(OFInvocation*)onSuccessInvocation onFailureInvocation:(OFInvocation*)onFailureInvocation onUploadBlobInvocation:(OFInvocation*)onUploadBlobInvocation;
