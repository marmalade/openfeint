...
-(OFChoiceButton*) initWithList:(OFChoiceListController*) _controller stringValue:(NSString*) _text value:(int) _value {
    if([super init] !=nil) {
...
//    [backgroundButton setBackgroundColor:[UIColor redColor]];
    ...
    for(unsigned int i=0; i<[self.choices count]; ++i)
    {
        ...
        OFChoiceButton *button = [[OFChoiceButton alloc] initWithList:self stringValue:itemText value:i];
