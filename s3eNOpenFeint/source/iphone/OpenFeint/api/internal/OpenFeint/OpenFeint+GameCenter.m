...
static OpenFeintGameCenter* gameCenter;
...
static void dumpPaginatedSeries(OFPaginatedSeries* series) 
{
...
static NSDictionary*buildLookupFromPage(OFPaginatedSeries* page) {
