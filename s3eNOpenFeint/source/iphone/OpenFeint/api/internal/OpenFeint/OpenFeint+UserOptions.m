...
static NSString* OpenFeintUserOptionUnreadAccountmentCount = @"OpenFeintUserOptionUnreadAccountmentCount";
...
+ (void)setUnreadAnnouncementCount:(NSInteger)unread
{
    [[NSUserDefaults standardUserDefaults] setInteger:unread forKey:OpenFeintUserOptionUnreadAccountmentCount];
    [OpenFeint postUnreadAnnouncementCountChangedTo:unread];
}

+ (NSInteger)unreadAccouncementCount
{
    return [[NSUserDefaults standardUserDefaults] integerForKey:OpenFeintUserOptionUnreadAccountmentCount];
}
