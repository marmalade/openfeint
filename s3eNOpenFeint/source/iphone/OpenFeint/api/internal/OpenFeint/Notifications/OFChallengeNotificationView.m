...
{
	OFChallengeNotificationView* view = (OFChallengeNotificationView*)[[OFControllerLoaderObjC loader] loadView:@"ChallengeNotificationView"];// loadView(@"ChallengeNotificationView");
...
- (void)_iconFinishedDownloading
{
    ...
    challengeIcon.imageDownloadInvocation = nil;
}
...
{	
	...
	if(notificationData.receivedChallengeToUser)
	{
        ...
        challengeIcon.imageDownloadInvocation = showAndDismiss;
