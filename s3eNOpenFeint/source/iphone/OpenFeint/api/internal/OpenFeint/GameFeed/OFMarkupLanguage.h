...
@interface OFMarkupLanguage : NSObject

+ (NSAttributedString*)attributedStringByParsingMarkup:(NSString*)text withAttributesFromLabel:(UILabel*)label;

/// Removes markup tags from the text, and returns the index in the string at which the color first changes, if applicable.
