...
#pragma mark ObjC
+ (OFRequestHandle*)getUser:(NSString*)userId onSuccessInvocation:(OFInvocation*)onSuccess onFailureInvocation:(OFInvocation*)onFailure;
+ (void)findUsersByName:(NSString*)name pageIndex:(NSInteger)pageIndex onSuccessInvocation:(OFInvocation*)onSuccess onFailureInvocation:(OFInvocation*)onFailure;
+ (void)findUsersForLocalDeviceOnSuccessInvocation:(OFInvocation*)onSuccess onFailureInvocation:(OFInvocation*)onFailure;

+ (void)getEmailForUser:(NSString*)userId onSuccessInvocation:(OFInvocation*)onSuccess onFailureInvocation:(OFInvocation*)onFailure;

+ (void) setUserLocation:(NSString*)userId location:(CLLocation*)location allowed:(BOOL)allowed onSuccessInvocation:(OFInvocation*)onSuccess onFailureInvocation:(OFInvocation*)onFailure;
#pragma mark -
@end
