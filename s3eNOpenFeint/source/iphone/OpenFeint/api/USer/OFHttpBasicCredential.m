...
[OFResourceField fieldSetter:@selector(setUserId:) getter:@selector(userId)], @"user_id",
[OFResourceField fieldSetter:@selector(setEmail:) getter:@selector(email)], @"email",
[OFResourceField fieldSetter:@selector(setCryptedPassword:) getter:@selector(cryptedPassword)], @"crypted_password",
[OFResourceField fieldSetter:@selector(setSalt:) getter:@selector(salt)], @"salt",
[OFResourceField fieldSetter:@selector(setRememberTokenAsString:) getter:@selector(getRememberTokenAsString)], @"remember_token",
[OFResourceField fieldSetter:@selector(setVerified:) getter:@selector(getVerifiedAsString)], @"verified",
[OFResourceField fieldSetter:@selector(setRememberTokenExpiresAt:) getter:@selector(rememberTokenExpiresAt)], @"remember_token_expires_at",
[OFResourceField fieldSetter:@selector(setCreatedAt:) getter:@selector(createdAt)], @"created_at",
[OFResourceField fieldSetter:@selector(setUpdatedAt:) getter:@selector(updatedAt)], @"updated_at",
[OFResourceField fieldSetter:@selector(setLastLoginAt:) getter:@selector(lastLoginAt)], @"last_login_at",
        nil] retain];
    }
