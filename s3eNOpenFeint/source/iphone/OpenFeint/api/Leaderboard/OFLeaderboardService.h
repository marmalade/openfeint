...
OPENFEINT_DECLARE_AS_SERVICE(OFLeaderboardService);
...
+ (void)getLeaderboardsForApplication:(NSString*)applicationId comparedToUserId:(NSString*)comparedToUserId onSuccessInvocation:(OFInvocation*)_onSuccess onFailureInvocation:(OFInvocation*)_onFailure;
