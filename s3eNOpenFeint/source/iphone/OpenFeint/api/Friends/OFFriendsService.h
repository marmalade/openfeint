...
+ (void)getAllUsersFollowedByLocalUserAlphabeticalInvocation:(OFInvocation*)_onSuccess onFailureInvocation:(OFInvocation*)_onFailure;// Same as getAllUsersFollowedByUserAlphabetical but only returns the users who have the application specified by applicationId
...
/// @param pageIndex		1 based page index
/// @param onSuccess		Delegate is passed an OFPaginatedSeries of tabledescriptions with OFGamePlayers which contain the users and the users gamerscore for this specific game.
/// @param onFailure		Delegate is called without parameters
///
