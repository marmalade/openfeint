...
//		[OFGameDiscoveryService getNowPlayingFeaturedPlacementInvocation:OFDelegate(self, @selector(onFeaturedGamesDownloaded:)) onFailureInvocation:OFDelegate()];
		[OFGameDiscoveryService getNowPlayingFeaturedPlacementInvocation:[OFInvocation invocationForTarget:self selector:@selector(onFeaturedGamesDownloaded:)]
