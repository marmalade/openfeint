...
#define kfTickerHeight 24.f
#define kfTabBarHeight 36.f
#define kfShieldWidth 40.f
#define kfShieldYOffset 19.f
#define kfShieldHeight (2.0f * (kfTickerHeight - kfShieldYOffset))
...
//    {
//        NSURL *apiURL = [NSURL URLWithString:[[OFSettings instance] getSetting:@"server-url"]];
...
- (id)init
{
	...
	if (self != nil)
	{
		...
		// build the ticker
		Class tickerClass = (Class)[[OFControllerLoaderObjC loader] viewClass:@"Ticker"];// getViewClass(@"Ticker");
...
//		self.tabBar.changeZOrderOnTap = NO;
...
+ (void)setOnlineMode:(OFTabBarController*)tabBarController
{
	...
	[[[OFControllerLoaderObjC loader] controllerClass:@"TabbedDashboard"] /*getControllerClass(@"TabbedDashboard")*/ _setOnlineMode:tabBarController];
...
{
	// dispatch to override class
	[[[OFControllerLoaderObjC loader] controllerClass:@"TabbedDashboard"] /*getControllerClass(@"TabbedDashboard")*/ _setOfflineMode:tabBarController];
}
