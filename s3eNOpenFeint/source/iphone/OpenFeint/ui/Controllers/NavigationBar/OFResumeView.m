...
static const float kGameIconSize = 20.f;
static const float kGameIconSizeLandscape = 15.f;
static const float kGameIconRightInset = 20.f;
static const float kStandardRightNavBarItemRightInset = 5.f;
// Our nav bar has a drop shadow making it non standard size
static const float kNavBarHeightPortrait = 44.f;
static const float kNavBarHeightLandscape = 39.f;
