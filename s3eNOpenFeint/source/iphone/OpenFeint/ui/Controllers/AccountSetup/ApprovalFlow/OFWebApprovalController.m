...
- (NSString*)getTitle
{
    return OFLOCALSTRING(@"Approve OF");
}
...
{
    [OpenFeint userDidApproveFeint:YES accountSetupCompleteInvocation:self.onApprovedInvocation];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    nativeController.approvedInvocation =self.onApprovedInvocation;
    nativeController.deniedInvocation = self.onDeniedInvocation;
	[[NSNotificationCenter defaultCenter] postNotificationName:@"OFNSNotificationFullscreenFrameOff" object:nil];
