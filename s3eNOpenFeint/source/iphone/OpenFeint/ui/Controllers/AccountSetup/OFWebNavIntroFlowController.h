...
@interface OFWebNavIntroFlowController : OFWebNavController {
    OFInvocation* mOnApprovedInvocation;
    OFInvocation* mOnDeniedInvocation;
...
@property (nonatomic, retain) OFInvocation* onApprovedInvocation;
@property (nonatomic, retain) OFInvocation* onDeniedInvocation;
