...
@private
	...
	UITextField* changedEmailField;
	NSString* emailAttemptingToClaim;
}

@property (nonatomic, retain) IBOutlet UILabel* currentEmailLabel;
@property (nonatomic, retain) IBOutlet UITextField* changedEmailField;
