...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
	...
	{
		[self.webNav executeJavascriptAsync:[NSString stringWithFormat:@"%@(%@);", self.cb, (alertView.cancelButtonIndex == buttonIndex ? @"false" : @"true")]];
	}
	[self release];
}
...
- (void)alertViewCancel:(UIAlertView *)alertView
{
	if (self.webNav && self.cb)
	{
		[self.webNav executeJavascriptAsync:[NSString stringWithFormat:@"%@(false);", self.cb]];
	}
	[self release];
}
