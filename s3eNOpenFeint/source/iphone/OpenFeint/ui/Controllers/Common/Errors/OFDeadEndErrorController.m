...
{
	OFDeadEndErrorController* deadEndError = (OFDeadEndErrorController*)[[OFControllerLoaderObjC loader] load:@"MustBeOnlineError"];// load(@"MustBeOnlineError");
	deadEndError.message = errorMessage;
	return deadEndError;
}

+ (id)deadEndErrorWithMessage:(NSString*)errorMessage
{
	OFDeadEndErrorController* deadEndError = (OFDeadEndErrorController*)[[OFControllerLoaderObjC loader] load:@"DeadEndError"];// load(@"DeadEndError");
	deadEndError.message = errorMessage;
	return deadEndError;
}
...
- (void)viewWillAppear:(BOOL)animated
{
	...
	self.title = OFLOCALSTRING(@"Error");
