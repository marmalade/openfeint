...
-(void)setSocialNotificationImageName:(NSString*)name
{
	[OFSocialNotificationService getImageUrlForNotificationImageNamed:name 
                                                  onSuccessInvocation:[OFInvocation invocationForTarget:self selector:@selector(_getSocialNotificationImageSuccess:)]
                                                  onFailureInvocation:[OFInvocation invocationForTarget:self selector:@selector(_getSocialNotificationImageFailure)]];
