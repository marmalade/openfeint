...
{
	[self.owner.navigationController pushViewController:[[OFControllerLoaderObjC loader] load:@"ImportFriends"] /*load(@"ImportFriends")*/ animated:YES];
}
...
- (void)setMissingCredentials:(NSArray*)missingUsersCredentials withNotice:(NSString*)notice
{
    ...
    OFLOCALIZECOMMENT("Fragment used later")
	NSString* socialNetworkNames = OFLOCALSTRING(@"your social networkNames");	
    ...
    OFLOCALIZECOMMENT("Multiple issues")
	NSString* formatString = OFLOCALSTRING(@"%@%@Import your friends from %@ to see what OpenFeint games they're playing, compare progress, and more.");	
