...
{
	return [[OFControllerLoaderObjC loader] load:@"Invitations"];// load(@"Invitations");
}

- (UIViewController*)onIMConversations
{
	return [[OFControllerLoaderObjC loader] load:@"InboxIMConversations"];// load(@"InboxIMConversations");
}

- (UIViewController*)onForumPosts
{
	return [[OFControllerLoaderObjC loader] load:@"InboxSubscribedForumThreads"];// load(@"InboxSubscribedForumThreads");
}
