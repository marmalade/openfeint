...
- (void)viewWillAppear:(BOOL)animated
{
	...
	self.title = OFLOCALSTRING(@"IM Conversations");
}

- (NSString*)getNoDataFoundMessage
{
	return OFLOCALSTRING(@"You don't have any active IM conversations. Send a message to a friend by pressing the compose button.");
}
