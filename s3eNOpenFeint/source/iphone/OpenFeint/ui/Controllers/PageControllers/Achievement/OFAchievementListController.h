...
@interface OFAchievementListController : OFTableSequenceControllerHelper< OFProfileFrame, OFBannerProvider >
{
@package
	...
	NSString* comparisonUserId;
	NSString* comparisonUserName;
	NSString* comparisonUserProfileImageUrl;
    OFUser* comparingUserForBannerCell;
}
...
@property (nonatomic, retain) NSString* comparisonUserName;
@property (nonatomic, retain) NSString* comparisonUserProfileImageUrl;
@property (nonatomic, retain) OFUser* comparingUserForBannerCell;
