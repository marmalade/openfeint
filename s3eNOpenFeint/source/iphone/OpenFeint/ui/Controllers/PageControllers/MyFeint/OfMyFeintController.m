...
{
	[self.navigationController pushViewController:[[OFControllerLoaderObjC loader] load:@"Friends"] /*load(@"Friends")*/ animated:YES];
}
...
{
	[self.navigationController pushViewController:[[OFControllerLoaderObjC loader] load:@"InboxTopLevel"] /*load(@"InboxTopLevel")*/ animated:YES];
}

- (IBAction)onSettings
{
	[self.navigationController pushViewController:[[OFControllerLoaderObjC loader] load:@"UserSetting"] /*load(@"UserSetting")*/ animated:YES];
}

- (IBAction)onHelp
{
	[self.navigationController pushViewController:[[OFControllerLoaderObjC loader] load:@"Help"] /*load(@"Help")*/ animated:YES];
}
