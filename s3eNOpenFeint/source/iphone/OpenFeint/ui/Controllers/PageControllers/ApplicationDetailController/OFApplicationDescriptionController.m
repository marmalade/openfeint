...
{
	OFApplicationDescriptionController* me = (OFApplicationDescriptionController*)[[OFControllerLoaderObjC loader] load:@"ApplicationDescription"];// load(@"ApplicationDescription");
...
{
    self.resourceId = [params objectForKey:@"appid"];
}
