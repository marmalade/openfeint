...
typedef enum OFChallengeListType { kChallengeListPending = 0, kChallengeListHistory, kChallengeListDefinitionStats } OFChallengeListType;

@interface OFChallengeDetailController : OFTableSequenceControllerHelper <UIAlertViewDelegate>
{
@package
