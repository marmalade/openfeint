...
// so we need to make sure we only hide it when both are NO.
...
- (void)doIndexActionWithPage:(NSUInteger)pageIndex onSuccessInvocation:(OFInvocation*)success onFailureInvocation:(OFInvocation*)failure
{
	...
	[OFFriendsService getInvitableFriends:pageIndex onSuccessInvocation:success onFailureInvocation:failure];
}
...
- (UIViewController*)getNoDataFoundViewController
{
    ...
    OFFullScreenImportFriendsMessage* noDataController = (OFFullScreenImportFriendsMessage*)[[OFControllerLoaderObjC loader] load:@"HeaderedFullscreenImportFriendsMessage"];// load(@"HeaderedFullscreenImportFriendsMessage");
	if (followingAnyone)
	{
...
//	[OFFriendsService isLocalUserFollowingAnyone:OFDelegate(self, @selector(localUserFollowingAnyone:)) 
//                                       onFailure:OFDelegate(self, @selector(localUserFollowingAnyoneFail))];
    [OFFriendsService isLocalUserFollowingAnyoneInvocation:[OFInvocation invocationForTarget:self selector:@selector(localUserFollowingAnyone:)] 
                                       onFailureInvocation:[OFInvocation invocationForTarget:self selector:@selector(localUserFollowingAnyoneFail)]];
...
{
	OFSelectFriendsToInviteController* controller = (OFSelectFriendsToInviteController*)[[OFControllerLoaderObjC loader] load:@"SelectFriendsToInvite"];// load(@"SelectFriendsToInvite");
