...
@class OFUser, OFUserCell, OFInviteDefinition, OFSelectInviteTypeController;

@interface OFSelectFriendsToInviteController : OFTableSequenceControllerHelper
{	
...
+ (OFSelectFriendsToInviteController*)inviteController:(OFSelectInviteTypeController*)parentController withAlreadySelectedUsers:(NSArray*)selectedUsers;
