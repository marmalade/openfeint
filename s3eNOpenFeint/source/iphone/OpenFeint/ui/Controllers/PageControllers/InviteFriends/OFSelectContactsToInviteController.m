...
{
	[resourceMap setObject:@"SelectableContact" forKey:[OFDeviceContact class]];
}
...
{
	OFSelectContactsToInviteController* controller = (OFSelectContactsToInviteController*)[[OFControllerLoaderObjC loader] load:@"SelectContactsToInvite"];// load(@"SelectContactsToInvite");
