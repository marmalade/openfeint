...
- (void)onResourceChanged:(OFResource*)resource
{
    ...
    /*
    frame = bubbleView.frame;
    OFLog(@"authorLabel.frame.size.height: %f, bodyLabel.frame.size.height: %f", authorLabel.frame.size.height, bodyLabel.frame.size.height);
    frame.size.height = authorLabel.frame.size.height + bodyLabel.frame.size.height;
    bubbleView.frame = frame;
     */
