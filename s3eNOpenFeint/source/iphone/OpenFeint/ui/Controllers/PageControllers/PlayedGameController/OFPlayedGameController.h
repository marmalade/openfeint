...
#define kNumSamples 10

@class OFService;

typedef enum OFPlayedGameScope { kPlayedGameScopeMyGames = 0, kPlayedGameScopeFriendsGames, kPlayedGameScopeTargetServiceIndex } OFPlayedGameScope;
