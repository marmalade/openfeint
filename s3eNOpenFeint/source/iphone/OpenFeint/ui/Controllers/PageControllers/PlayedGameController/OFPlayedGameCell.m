...
- (void)onResourceChanged:(OFResource*)resource
{
	...
	else
	{
        ...
        OFLOCALIZECOMMENT("Multiple piece text")
		friendsWithAppLabel.text = [NSString stringWithFormat:OFLOCALSTRING(@"%d %@ this game"), playedGame.friendsWithApp, playedGame.friendsWithApp == 1 ? @"friend has" : @"friends have"];
	}
