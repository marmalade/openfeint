...
{
	[OFGameDiscoveryService getGameDiscoveryCategoriesOnSuccessInvocation:success onFailureInvocation:failure];
}

- (NSString*)getNoDataFoundMessage
{
	return OFLOCALSTRING(@"No game categories were found. This is probably an error.");
}
...
- (void)_createAndDisplayTableHeader
{
	...
	message.text = OFLOCALSTRING(@"For more games visit www.openfeint.com!");
