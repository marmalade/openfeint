...
static float const kfDisclosureRightInset = 22.f;

@implementation OFGameDiscoveryCategoryCell

@synthesize iconView, iconFrame, textContentView, nameLabel, subtextLabel, secondaryTextLabel, topDividerView, bottomDividerView, disclosureView;
...
- (void)layoutSubviews
{
	...
	CGRect disclosureFrame = disclosureView.frame;
	disclosureFrame.origin.x = CGRectGetMaxX(self.frame) - kfDisclosureRightInset;
	disclosureView.frame = disclosureFrame;
	
	disclosureView.image = [OFImageLoader loadImage:([OpenFeint isLargeScreen] ? @"OFCustomDisclosureIPad.png" : @"OFCustomDisclosure.png")];
