...
- (IBAction)onClickedFeintName
{
	...
	//If the resource id is nil, they selected an admin.  We don't want to show their profile.
	if (message.user != nil && message.user.resourceId != nil)
	{
...
- (void)onResourceChanged:(OFResource*)resource
{
	...
	NSString* chatMessageText = message.message;
