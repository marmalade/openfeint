...
//////////////////////////////////////////////////////////////////////////////////////////
/// The public interface for OFChallengeDefinition allows you to see the details of a challenge
/// definition.  These are the objects related to the challenge types you've defined in
/// the Developer Dashboard.
//////////////////////////////////////////////////////////////////////////////////////////
@interface OFChallengeDefinition : OFResource
{
	@package
	NSString* title;
...
//////////////////////////////////////////////////////////////////////////////////////////
/// Whether or not the receiver of this challenge can attempt it multiple times to complete.
//////////////////////////////////////////////////////////////////////////////////////////
...
@optional
//////////////////////////////////////////////////////////////////////////////////////////
/// Invoked by an OFChallengeDefinition  when downloadAllChallengeDefinitions successfully completes.
//////////////////////////////////////////////////////////////////////////////////////////
- (void)didDownloadAllChallengeDefinitions:(NSArray*)challengeDefinitions;

//////////////////////////////////////////////////////////////////////////////////////////
/// Invoked by an OFChallengeDefinition  when downloadAllChallengeDefinitions fails.
//////////////////////////////////////////////////////////////////////////////////////////
- (void)didFailDownloadChallengeDefinitions;

//////////////////////////////////////////////////////////////////////////////////////////
/// Invoked by an OFChallengeDefinition  when downloadChallengeDefinitionWithId successfully completes.
//////////////////////////////////////////////////////////////////////////////////////////
- (void)didDownloadChallengeDefinition:(OFChallengeDefinition*)challengeDefinition;

//////////////////////////////////////////////////////////////////////////////////////////
/// Invoked by an OFChallengeDefinition  when downloadChallengeDefinitionWithId fails.
////////////////////////////////////////////////////////////////////////////////////////
