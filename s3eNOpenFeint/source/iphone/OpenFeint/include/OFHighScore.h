...
//////////////////////////////////////////////////////////////////////////////////////////
/// Get an NSArray* of scores near the user's high score.  The array will contain the user's highscore centered between the worse and better scores.
///
/// @param leaderboard		The leaderboard which you want to search for high scores.
/// @param betterCount		The number of scores you want that are better than the current user's score. Max is 50.
/// @param worseCount		The number of scores you want that are worse than the current user's score. Max is 50.
///
...
//////////////////////////////////////////////////////////////////////////////////////////
/// Initializes a HighScore for submission.  Use OFLeaderboard's submitScore: to submit 
/// this score to a leaderboard.
///
/// @param submitScore		The score to submit.
///
/// @note	You may optionally also fill out the 
///			displayText
///			customData 
///			blob
...
/// be filled out if there is data attached to this high score.
///
/// @return OFRequestHandle for the server request.  Use this to cancel the request.
///
...
///
/// @param score			The score that was successfully submitted.
//////////////////////////////////////////////////////////////////////////////////////////
...
///					player's score will be in this list as well.
//////////////////////////////////////////////////////////////////////////////////////////
