...
/// other users or query challenge data (if it's a member of an OFChallengeToUser).
//////////////////////////////////////////////////////////////////////////////////////////
...
///
/// @param definition			The challenge definition.
...
///
/// @note	You may optionally also fill out
///			<ul>
///			<li>userMessage<br>A message entered by the user specific to this challenge. If the user does not enter
///							one a default message should be provided instead.</li>
///			<li>hiddenText<br>Not used directly by OpenFeint. Use this if you want to display any extra data with the 
///							challenge when implementing your own UI.</li></ul>
//////////////////////////////////////////////////////////////////////////////////////////
...
/// @note	When this UI is displayed, it will prompt the user to fill out the user message
...
//////////////////////////////////////////////////////////////////////////////////////////
///
/// Downloads challenge data for a particular challenge.
/// 
...
///								If you are using the OpenFeint views to accept challenges, then you should check out
...
///
/// @note Invokes				
///								- (void)didDownloadChallengeData:(NSData*)data OFChallenge:(OFChallenge*)challenge on success and
...
//////////////////////////////////////////////////////////////////////////////////////////
/// The challenger.
/// @note When calling sendChallenge:... this is nil because the challenger is always the current user.
//////////////////////////////////////////////////////////////////////////////////////////
