...
//////////////////////////////////////////////////////////////////////////////////////////
typedef enum OFCloudStorageStatus_Code 
{
...
} OFCloudStorageStatus_Code;

//////////////////////////////////////////////////////////////////////////////////////////
/// The public interface for OFCloudStorage allows you to upload and download data from
/// the Open Feint server.  Data is associated uniquely in 3 fields<ul><li>client application id</li>
/// <li>current user id</li><li>key passed in by the developer</li></ul>.  This allows you to have static
/// keys for your data in your application across all users 
///	(ex. static NSString* saveGameDataKey = @"SaveGameData")
//////////////////////////////////////////////////////////////////////////////////////////
@interface OFCloudStorage : NSObject
