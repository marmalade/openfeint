...
public class TwoLineNotification extends NotificationBase {
	...
	{
		show(text, extra, Category.Foreground);
	}
	
	public static void show(String text, String extra, Category c) {
		show(text, extra, c, Type.None);
	}
	...
	public static void show(String text, String extra, String imageName) {
		show(text, extra, imageName, Category.Foreground);
	}
	
	public static void show(String text, String extra, String imageName, Category c ) {
		show(text, extra, imageName, c, Type.None);
	}
