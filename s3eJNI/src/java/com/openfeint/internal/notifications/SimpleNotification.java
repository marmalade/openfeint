...
public class SimpleNotification extends NotificationBase {
	...
	{
		show(text, Category.Foreground);
	}
	
	public static void show(String text, Category c) {
		show(text, c, Type.None);
	}
	...
	public static void show(String text, String imageName) {
		show(text, imageName, Category.Foreground);
	}
	
	public static void show(String text, String imageName, Category c ) {
		show(text, imageName, c, Type.None);
	}
